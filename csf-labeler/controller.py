...
scanned_code = ""
input_code = ""
keys = "X^1234567890-XXXqwertzuiop{}XXasdfghjkl:'XXXyxcvbnm,XXXXX XXXXXXXXXXXXXXXX"
...
class ButtonsReader(Thread):
    ...
    def send_url_request(self):
        global scanned_code
        url = "https://3001-jacra-guardianconnect-p8305nx0xh1.ws-us44.gitpod.io/api/user"
        request_data = {'email': 'python@test.com', 'password':'test'}
